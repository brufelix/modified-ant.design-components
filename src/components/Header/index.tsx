...
const styleHeader: React.CSSProperties = {
    ...
    fontSize: "1.5em", height: 64, backgroundColor: "#52DF9A",
    borderBottom: 'solid 4px #00B894', fontFamily: 'sans-serif',
    fontWeight: 100
}
...
function Header(): JSX.Element {
    ...
    return (
        <Header style={styleHeader}>
            ...
            <Avatar size="small" style={{ border: 'solid 2px #00B894' }} icon={<UserOutlined />} />
